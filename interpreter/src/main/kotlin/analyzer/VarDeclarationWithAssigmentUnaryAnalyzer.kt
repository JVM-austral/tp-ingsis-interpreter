...
class VarDeclarationWithAssigmentUnaryAnalyzer(
    ...
    override fun getExecutor(
        heap: MutableMap<String, VariableInfo>,
        env: MutableMap<String, Ast>,
    ): InterpreterExecutor = VarDeclarationWithAssigmentUnaryExecutor(engine, conditionHandler, isCompatibleTypeCondition)
}
