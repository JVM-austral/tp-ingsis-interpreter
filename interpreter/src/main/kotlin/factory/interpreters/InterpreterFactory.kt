...
class InterpreterFactory {
    ...
    fun createInterpreterV2(heap: MutableMap<String, VariableInfo>, outputHandler: OutputHandler, env:  MutableMap<String, Ast>, inputProvider: InputProvider, converter: LiteralConverter
    ): Interpreter {
