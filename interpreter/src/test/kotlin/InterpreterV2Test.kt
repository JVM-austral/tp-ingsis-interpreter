...
class InterpreterV2Test {
    ...
    fun `should assign from env `() {
        ...
        val assigment =
            VarDeclaration(
                ...
                FunctionCallAst("readEnv", listOf(StringLiteral("MY_VAR", 0, 0)), 0, 0),
                0,
                0,
            )
    ...
    fun `should print with input`() {
        ...
        val println =
            FunctionCallAst(
                "println",
                listOf(BinaryOperation("+", StringLiteral("Hello ", 0, 0), VariableIdentifier("name", 0, 0), 0, 0)),
                0,
                0,
            )
